...
import { Text, Modal, View, ScrollView, StyleSheet, Picker, Switch, Button, Alert } from 'react-native';
...
handleReservation() {
    Alert.alert(
        ...
        [
        {text: 'Cancel', onPress: () => this.props.resetForm},
        {text: 'OK', onPress: () => {
            this.props.resetForm; this.presentLocalNotification(this.state.date);
